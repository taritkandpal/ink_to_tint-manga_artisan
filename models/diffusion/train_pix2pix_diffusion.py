...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=int,
        default=DIFFUSION_NUM_VAL_IMAGES,  # 4,
    ...
    parser.add_argument(
        ...
        type=int,
        # default=100,
        default=DIFFUSION_TRAIN_EPOCHS,
    )
    parser.add_argument(
        "--max_train_steps",
        type=int,
    ...
    parser.add_argument(
        ...
        type=str,
        # default="constant",
        default=DIFFUSION_LR_SCHEDULER,
        help=(
    ...
    parser.add_argument(
        "--adam_beta1",
        type=float,
        default=DIFFUSION_ADAM_BETA1,
        help="The beta1 parameter for the Adam optimizer.",
    )
    parser.add_argument(
        "--adam_beta2",
        type=float,
        default=DIFFUSION_ADAM_BETA2,
        help="The beta2 parameter for the Adam optimizer.",
    )
    parser.add_argument(
        "--adam_weight_decay",
        type=float,
        default=DIFFUSION_ADAM_DECAY,
    ...
    parser.add_argument(
        "--mixed_precision",
        type=str,
        default=DIFFUSION_MIXED_PRECISION,  # None,
...
def validation_fetch_data(args):
    ...
    for cnt, ddict in enumerate(metadata):
        if cnt >= args.num_validation_images:
            break
...
def main():
    ...
    def preprocess_images(examples):
        ...
        original_images = np.concatenate(
            [
                convert_to_np(
                    Image.open(os.path.join(DIFFUSION_TRAIN_DATA, image)),
                    args.resolution,
                )
                for image in examples[original_image_column]
            ]
    ...
    for epoch in range(first_epoch, args.num_train_epochs):
        ...
        if accelerator.is_main_process:
            if (args.val_data_dir is not None) and (
